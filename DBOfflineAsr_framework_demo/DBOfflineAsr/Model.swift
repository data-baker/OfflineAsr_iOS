...
func getMultilingualModelConfig2022_12_06() -> SherpaNcnnModelConfig {
  ...
  let tokens = getResource("tokens", "txt")
    return DBOfflineRecognizerConfig.configEncoderParam(encoderParam, encoderBin: encoderBin, decoderParam: decoderParam, decoderBin: decoderBin, joinerParam: joinerParam, joinerBin: joinerBin, tokens: tokens, numThreads: 4, useVulkanComute: true)
}
