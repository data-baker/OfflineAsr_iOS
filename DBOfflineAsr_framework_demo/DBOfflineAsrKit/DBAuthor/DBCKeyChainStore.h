...
extern NSString * const DBCKeyChainStoreErrorDomain;
...
@interface DBCKeyChainStore : NSObject
...
+ (DBCKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (DBCKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
@interface DBCKeyChainStore (ErrorHandling)
...
@interface DBCKeyChainStore (ForwardCompatibility)
...
@interface DBCKeyChainStore (Deprecation)
